  ...
  en: {
    translation: {
      ...
      usage_stats: {
        ...
        codex_pool_subtitle: 'Quota, score, reset, and manual routing weight from the enhanced CPA Codex state API.',
        ...
        codex_pool_manual: 'Manual',
        codex_pool_weekly_reset: 'Weekly Reset',
  ...
  zh: {
    translation: {
      ...
      usage_stats: {
        ...
        codex_pool_subtitle: '查看增强 CPA Codex 状态接口中的额度、分数、重置时间和手动路由权重。',
        ...
        codex_pool_score: '分数',
        codex_pool_manual: '手动权重',
        codex_pool_weekly_reset: '周重置',
  ...
  'zh-TW': {
    translation: {
      ...
      usage_stats: {
        ...
        codex_pool_subtitle: '查看增強 CPA Codex 狀態介面中的額度、分數、重置時間和手動路由權重。',
        ...
        codex_pool_score: '分數',
        codex_pool_manual: '手動權重',
        codex_pool_weekly_reset: '週重置',
        codex_pool_recent_refresh: '最近刷新',
