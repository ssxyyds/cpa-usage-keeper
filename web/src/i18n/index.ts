  ...
  en: {
    translation: {
      ...
      usage_stats: {
        ...
        credentials_search_label: 'Search',
        credentials_search_placeholder: 'Account, email, id, note, or plan',
        ...
        credentials_sort_codex_score_desc: 'Codex score high',
        credentials_sort_codex_score_asc: 'Codex score low',
        credentials_codex_score: 'Codex Score',
        credentials_codex_manual_score: 'Codex manual score',
        credentials_codex_score_edit: 'Edit Codex manual score',
        ...
        credentials_quota_amount: 'Estimated quota',
        credentials_quota_remaining: '{{count}} left',
        credentials_quota_percent_used: '{{percent}} used',
        credentials_codex_probe: 'probe',
        credentials_codex_bootstrap_next_after: 'bootstrap_next_after',
        credentials_codex_refresh_error: 'refresh_error',
        ...
        codex_pool_title: 'Codex Pool',
        codex_pool_subtitle: 'Quota, score, reset, and manual routing adjustment from the enhanced CPA Codex state API.',
        codex_pool_score_tip: 'Score is the final routing priority: quota remaining divided by time to reset, plus urgency and manual adjustment.',
        codex_pool_manual_tip: 'Manual adjustment is not a separate weight; it adds to or subtracts from the final score for routing preference.',
        codex_pool_routing_strategy: 'Routing strategy',
        codex_pool_search_placeholder: 'Search account, email, id, or type',
        codex_pool_search_count: '{{count}} accounts',
        codex_pool_reload: 'Reload',
        codex_pool_working: 'Working',
        codex_pool_refresh_quota: 'Refresh Quota',
        codex_pool_recalculate: 'Recalculate',
        codex_pool_accounts: 'Accounts',
        codex_pool_unavailable: 'unavailable {{count}}',
        codex_pool_weekly_remaining: 'Weekly Remaining',
        codex_pool_five_hour_remaining: '5h Remaining',
        codex_pool_known_ratio: '{{ratio}} known {{count}}',
        codex_pool_disabled: 'Disabled',
        codex_pool_cooldown: 'cooldown {{count}}',
        codex_pool_last_refresh: 'Last Refresh',
        codex_pool_account: 'Account',
        codex_pool_weekly: 'Weekly',
        codex_pool_five_hour: '5h',
        codex_pool_score: 'Score',
        codex_pool_manual: 'Manual adjust',
        codex_pool_quota_reset: 'Quota Reset',
        codex_pool_recent_refresh: 'Recent Refresh',
        codex_pool_current_account: 'Current account',
        codex_pool_current_account_by_model: 'Current accounts by model',
        codex_pool_default_model: 'default',
        codex_pool_current_badge: 'current',
        codex_pool_status_active: 'active',
        codex_pool_status_disabled: 'disabled',
        codex_pool_status_unavailable: 'unavailable',
        codex_pool_empty: 'No Codex account state yet.',
        codex_pool_load_failed: 'Unable to load Codex pool state',
        codex_pool_action_failed: 'Codex pool action failed',
        codex_overview_title: 'Codex routing overview',
        codex_overview_source: 'CPA state',
        codex_overview_strategy: 'Routing strategy',
        codex_overview_strategy_hint: 'Score ranks accounts by quota remaining, reset timing, freshness, and manual adjustment.',
        codex_overview_weekly_total: 'Weekly remaining total',
        codex_overview_five_hour_total: '5h remaining total',
        codex_overview_known_count: '{{value}} accounts known',
  ...
  zh: {
    translation: {
      ...
      usage_stats: {
        ...
        credentials_search_label: '搜索',
        credentials_search_placeholder: '账号、邮箱、ID、备注或套餐',
        ...
        credentials_sort_codex_score_desc: 'Codex 分数高到低',
        credentials_sort_codex_score_asc: 'Codex 分数低到高',
        credentials_codex_score: 'Codex 分数',
        credentials_codex_manual_score: 'Codex 手动分数',
        credentials_codex_score_edit: '编辑 Codex 手动分数',
        ...
        credentials_quota_amount: '估算额度金额',
        ...
        codex_pool_title: 'Codex 号池',
        codex_pool_subtitle: '查看增强 CPA Codex 状态接口中的额度、分数、重置时间和手动调分。',
        codex_pool_reload: '重新加载',
        codex_pool_working: '处理中',
        codex_pool_refresh_quota: '刷新额度',
        codex_pool_recalculate: '重新计算',
        codex_pool_accounts: '账号',
        codex_pool_unavailable: '不可用 {{count}}',
        codex_pool_weekly_remaining: '周剩余额度',
        codex_pool_five_hour_remaining: '5小时剩余额度',
        codex_pool_known_ratio: '{{ratio}} 已知 {{count}}',
        codex_pool_disabled: '已禁用',
        codex_pool_cooldown: '冷却 {{count}}',
        codex_pool_last_refresh: '最近刷新',
        codex_pool_account: '账号',
        codex_pool_weekly: '周额度',
        codex_pool_five_hour: '5小时',
        codex_pool_score: '分数',
        codex_pool_manual: '手动调分',
        codex_pool_score_tip: '分数是最终路由优先级：剩余额度除以距离重置时间，再加快到期奖励和手动调分。',
        codex_pool_manual_tip: '手动调分不是独立权重；它会加到或减到最终分数里，用来人工提高或降低账号优先级。',
        codex_pool_routing_strategy: '当前选号策略',
        codex_pool_search_placeholder: '搜索账号、邮箱、ID 或类型',
        codex_pool_search_count: '{{count}} 个账号',
        codex_pool_quota_reset: '额度重置',
        codex_pool_recent_refresh: '最近刷新',
        codex_pool_current_account: '当前账号',
        codex_pool_current_account_by_model: '当前账号（按模型）',
        codex_pool_default_model: '默认',
        codex_pool_current_badge: '当前',
        codex_pool_status_active: '可用',
        codex_pool_status_disabled: '已禁用',
        codex_pool_status_unavailable: '不可用',
        codex_pool_empty: '暂无 Codex 账号状态。',
        codex_pool_load_failed: '无法加载 Codex 号池状态',
        codex_pool_action_failed: 'Codex 号池操作失败',
        codex_overview_title: 'Codex 调度概览',
        codex_overview_source: '来自 CPA',
        codex_overview_strategy: '当前选号策略',
        codex_overview_strategy_hint: '分数按剩余额度、重置时间、刷新新鲜度和手动调分综合计算。',
        codex_overview_weekly_total: '周剩余额度（总）',
        codex_overview_five_hour_total: '5小时剩余额度（总）',
        codex_overview_known_count: '已知 {{value}} 个账号',
        previous_page: '上一页',
        next_page: '下一页',
        rows_per_page: '每页显示',
        success_count: '成功',
  ...
  'zh-TW': {
    translation: {
      ...
      usage_stats: {
        ...
        credentials_search_label: '搜尋',
        credentials_search_placeholder: '帳號、信箱、ID、備註或方案',
        credentials_sort_label: '排序',
        credentials_sort_priority: '優先級',
        credentials_sort_total_requests: '請求總數',
        credentials_sort_total_tokens: 'Token 總數',
        credentials_sort_codex_score_desc: 'Codex 分數高到低',
        credentials_sort_codex_score_asc: 'Codex 分數低到高',
        credentials_codex_score: 'Codex 分數',
        credentials_codex_manual_score: 'Codex 手動分數',
        credentials_codex_score_edit: '編輯 Codex 手動分數',
        ...
        credentials_quota_amount: '估算額度金額',
        ...
        codex_pool_title: 'Codex 號池',
        codex_pool_subtitle: '查看增強 CPA Codex 狀態介面中的額度、分數、重置時間和手動調分。',
        codex_pool_reload: '重新載入',
        codex_pool_working: '處理中',
        codex_pool_refresh_quota: '刷新額度',
        codex_pool_recalculate: '重新計算',
        codex_pool_accounts: '帳號',
        codex_pool_unavailable: '不可用 {{count}}',
        codex_pool_weekly_remaining: '週剩餘額度',
        codex_pool_five_hour_remaining: '5小時剩餘額度',
        codex_pool_known_ratio: '{{ratio}} 已知 {{count}}',
        codex_pool_disabled: '已停用',
        codex_pool_cooldown: '冷卻 {{count}}',
        codex_pool_last_refresh: '最近刷新',
        codex_pool_account: '帳號',
        codex_pool_weekly: '週額度',
        codex_pool_five_hour: '5小時',
        codex_pool_score: '分數',
        codex_pool_manual: '手動調分',
        codex_pool_score_tip: '分數是最終路由優先級：剩餘額度除以距離重置時間，再加快到期獎勵和手動調分。',
        codex_pool_manual_tip: '手動調分不是獨立權重；它會加到或減到最終分數裡，用來人工提高或降低帳號優先級。',
        codex_pool_routing_strategy: '目前選號策略',
        codex_pool_search_placeholder: '搜尋帳號、信箱、ID 或類型',
        codex_pool_search_count: '{{count}} 個帳號',
        codex_pool_quota_reset: '額度重置',
        codex_pool_recent_refresh: '最近刷新',
        codex_pool_current_account: '目前帳號',
        codex_pool_current_account_by_model: '目前帳號（按模型）',
        codex_pool_default_model: '預設',
        codex_pool_current_badge: '目前',
        codex_pool_status_active: '可用',
        codex_pool_status_disabled: '已停用',
        codex_pool_status_unavailable: '不可用',
        codex_pool_empty: '暫無 Codex 帳號狀態。',
        codex_pool_load_failed: '無法載入 Codex 號池狀態',
        codex_pool_action_failed: 'Codex 號池操作失敗',
        codex_overview_title: 'Codex 調度概覽',
        codex_overview_source: '來自 CPA',
        codex_overview_strategy: '目前選號策略',
        codex_overview_strategy_hint: '分數按剩餘額度、重置時間、刷新新鮮度和手動調分綜合計算。',
        codex_overview_weekly_total: '週剩餘額度（總）',
        codex_overview_five_hour_total: '5小時剩餘額度（總）',
        codex_overview_known_count: '已知 {{value}} 個帳號',
        previous_page: '上一頁',
        next_page: '下一頁',
        rows_per_page: '每頁顯示',
        success_count: '成功',
