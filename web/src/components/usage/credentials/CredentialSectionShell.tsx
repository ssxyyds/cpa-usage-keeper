...
export function MetricPill({ label, value, className }: { label: string; value: ReactNode; className?: string }) {
  return (
    <span className={`${styles.credentialMetricPill} ${className ?? ''}`.trim()}>
