...
describe('Credential section styles', () => {
  ...
  it('keeps Codex score editing out of Auth Files metrics', () => {
    expect(authFileSectionSource).not.toContain('credentialCodexScorePill')
    expect(authFileSectionSource).not.toContain('CodexScoreMetric')
  })
